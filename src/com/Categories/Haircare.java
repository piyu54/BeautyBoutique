...
public class Haircare 
{
	int pId;
	 ...
	 int quantity;
	  int price;
		public Haircare(int pId, String pName, String pdescp,  int quantity,int price) {
		...
		public  void getHaircare() throws SQLException {
			...
			try {
				...
				preparedStatement = connection.prepareStatement("select * from Haircare");
