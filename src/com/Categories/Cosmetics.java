...
public class Cosmetics 
{
	int pId;
	 ...
	 int quantity;
	  int price;
		public Cosmetics(int pId, String pName, String pdescp,  int quantity,int price) {
		...
		public  void getCosmetics() throws SQLException {
			...
			try {
				...
				preparedStatement = connection.prepareStatement("select * from Cosmetics");
