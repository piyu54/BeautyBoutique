...
public class Skincare 
{
	int pId;
	 ...
	 int quantity;
	  int price;
		public Skincare(int pId, String pName, String pdescp,  int quantity,int price) {
		...
		public  void getSkincare() throws SQLException {
			...
			try {
				...
				preparedStatement = connection.prepareStatement("select * from Skincare");
