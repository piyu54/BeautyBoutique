...
public class Bodycare 
{
	int pId;
	 ...
	 int quantity;
	  int price;
		public Bodycare(int pId, String pName, String pdescp,  int quantity,int price) {
		...
		public  void getbodycare() throws SQLException {
			...
			try {
				...
				preparedStatement = connection.prepareStatement("select * from bodycare");
